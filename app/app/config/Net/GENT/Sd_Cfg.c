...
static Sd_EventHandlerSubscriberType Sd_EventHandlerSubscriber_client0_event_group2[3];
static const Sd_EventHandlerType Sd_EventHandlers_client0[] = {
  {
    ...
    Sd_EventHandlerSubscriber_client0_event_group2,
    ARRAY_SIZE(Sd_EventHandlerSubscriber_client0_event_group2),
  },
};
