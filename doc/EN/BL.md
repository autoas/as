...
- `python` (to run the generator script `tools/utils/gensims19.py`)
...
Use the generator script [tools/utils/gensims19.py](../../tools/utils/gensims19.py) to create a dummy flash driver file with sequential values (0, 1, 2, ..., 255, 0, 1, ...) at address 0, placed in the CanBL build folder:
...
The generator script [tools/utils/gensims19.py](../../tools/utils/gensims19.py) generates multi-section S19 files.
