...
所以，我的库是使用python scons控制构建的，其具有相当高的灵活性和可控性。这里不做过多的介绍了，这里将介绍如果你想在Windows上评估或者学习[autoas/as](https://github.com/autoas/as)这个库（后面将简称ssas），如何搭建起仿真开发环境。
...
当你安装好如下软件后，你就可以双击ssas工程目录下的[Console.bat](../../Console.bat), 其会自动下载安装[ConEmu](https://conemu.github.io/)(一个windows下非常好用的命令行终端工具)。当然由于国内经常访问github会出错的问题，你也可以手动下载[ConEmu Portable](https://www.fosshub.com/ConEmu.html)版本，并安装到as/download/ConEmu目录下，如下图所示，之后在重新双击[Console.bat](../../Console.bat), 启动ssas开发终端。
