...
int UniqueIdentifier_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void UniqueIdentifier_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void UniqueIdentifier_free(asn_TYPE_descriptor_t *td, void *struct_ptr, int contents_only) {
  UniqueIdentifier_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int UniqueIdentifier_print(asn_TYPE_descriptor_t *td, const void *struct_ptr, int ilevel,
                           asn_app_consume_bytes_f *cb, void *app_key) {
  UniqueIdentifier_1_inherit_TYPE_descriptor(td);
  return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}

asn_dec_rval_t UniqueIdentifier_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t UniqueIdentifier_encode_der(asn_TYPE_descriptor_t *td, void *structure, int tag_mode,
...
asn_dec_rval_t UniqueIdentifier_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                           asn_TYPE_descriptor_t *td, void **structure,
...
asn_enc_rval_t UniqueIdentifier_encode_xer(asn_TYPE_descriptor_t *td, void *structure, int ilevel,
...
asn_TYPE_descriptor_t asn_DEF_UniqueIdentifier = {
  ...
  sizeof(asn_DEF_UniqueIdentifier_tags_1) / sizeof(asn_DEF_UniqueIdentifier_tags_1[0]), /* 1 */
