...
int AttributeType_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void AttributeType_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void AttributeType_free(asn_TYPE_descriptor_t *td, void *struct_ptr, int contents_only) {
  AttributeType_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int AttributeType_print(asn_TYPE_descriptor_t *td, const void *struct_ptr, int ilevel,
                        asn_app_consume_bytes_f *cb, void *app_key) {
  AttributeType_1_inherit_TYPE_descriptor(td);
  return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}

asn_dec_rval_t AttributeType_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t AttributeType_encode_der(asn_TYPE_descriptor_t *td, void *structure, int tag_mode,
...
asn_dec_rval_t AttributeType_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
                                        void **structure, const char *opt_mname, const void *bufptr,
                                        size_t size) {
  AttributeType_1_inherit_TYPE_descriptor(td);
  return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}

asn_enc_rval_t AttributeType_encode_xer(asn_TYPE_descriptor_t *td, void *structure, int ilevel,
...
static const ber_tlv_tag_t asn_DEF_AttributeType_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (6 << 2))};
asn_TYPE_descriptor_t asn_DEF_AttributeType = {
  ...
  sizeof(asn_DEF_AttributeType_tags_1) / sizeof(asn_DEF_AttributeType_tags_1[0]), /* 1 */
