...
void AttributeValue_free(asn_TYPE_descriptor_t *td, void *struct_ptr, int contents_only) {
  AttributeValue_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int AttributeValue_print(asn_TYPE_descriptor_t *td, const void *struct_ptr, int ilevel,
                         asn_app_consume_bytes_f *cb, void *app_key) {
  AttributeValue_1_inherit_TYPE_descriptor(td);
  return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}

asn_dec_rval_t AttributeValue_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t AttributeValue_encode_der(asn_TYPE_descriptor_t *td, void *structure, int tag_mode,
...
asn_dec_rval_t AttributeValue_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t AttributeValue_encode_xer(asn_TYPE_descriptor_t *td, void *structure, int ilevel,
