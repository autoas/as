...
static asn_TYPE_member_t asn_MBR_Validity_1[] = {
  {ATF_NOFLAGS, 0, offsetof(struct Validity, notBefore), -1 /* Ambiguous tag (CHOICE?) */, 0,
   &asn_DEF_DateTime, 0, /* Defer constraints checking to the member type */
   0,                    /* PER is not compiled, use -gen-PER */
   0, "notBefore"},
  {ATF_NOFLAGS, 0, offsetof(struct Validity, notAfter), -1 /* Ambiguous tag (CHOICE?) */, 0,
   &asn_DEF_DateTime, 0, /* Defer constraints checking to the member type */
   0,                    /* PER is not compiled, use -gen-PER */
   0, "notAfter"},
};
static const ber_tlv_tag_t asn_DEF_Validity_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
...
asn_TYPE_descriptor_t asn_DEF_Validity = {
  ...
  sizeof(asn_DEF_Validity_tags_1) / sizeof(asn_DEF_Validity_tags_1[0]), /* 1 */
